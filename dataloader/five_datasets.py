...
five_data_dir = '/root/data/'
file_dir = '/root/data/binary_mixture_5_Data/'
    ...
    if not os.path.isdir(file_dir):
        ...
        for n,idx in enumerate(idata):
            if idx==0:
                ...
                std=(0.3318,)
                dat={}
                dat['train']=FashionMNIST(five_data_dir+'/fashion_mnist', train=True, download=True, transform=transforms.Compose([
                    transforms.Pad(padding=2, fill=0), transforms.ToTensor(),transforms.Normalize(mean, std)]))
                dat['test']=FashionMNIST(five_data_dir+'/fashion_mnist', train=False, download=True, transform=transforms.Compose([
                    transforms.Pad(padding=2, fill=0), transforms.ToTensor(),transforms.Normalize(mean, std)]))
                data[n]={}
                ...
                std=(0.4501,)
                dat={}
                dat['train']=notMNIST(five_data_dir+'/notmnist', train=True, download=True, transform=transforms.Compose([transforms.ToTensor(),transforms.Normalize(mean,std)]))
                dat['test']=notMNIST(five_data_dir+'/notmnist', train=False, download=True, transform=transforms.Compose([transforms.ToTensor(),transforms.Normalize(mean,std)]))
                data[n]={}
            ...
            for s in ['train','test']:
                ...
                torch.save(data[n][s]['x'], os.path.join(os.path.expanduser(five_data_dir+'/binary_mixture_5_Data'),'data'+str(idx)+s+'x.bin'))
                torch.save(data[n][s]['y'], os.path.join(os.path.expanduser(five_data_dir+'/binary_mixture_5_Data'),'data'+str(idx)+s+'y.bin'))
        ...
        for n,idx in enumerate(idata):
            ...
            for s in ['train','test']:
                data[n][s]={'x':[],'y':[]}
                data[n][s]['x'] = torch.load(os.path.join(os.path.expanduser(five_data_dir+'/binary_mixture_5_Data'),'data'+str(idx)+s+'x.bin'))
                data[n][s]['y'] = torch.load(os.path.join(os.path.expanduser(five_data_dir+'/binary_mixture_5_Data'),'data'+str(idx)+s+'y.bin'))
